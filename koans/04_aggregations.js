...
module.exports = (lang = 'en') => {
  const translations = {
    en: {
      title: "04 - Aggregation Functions",
      description: "Learn to calculate statistics on data",
      koans: [
        {
          id: 1,
          ...
          expectedMessage: "Should return 12 (total employees)"
        },

        {
          id: 2,
          name: "Calculate sum of salaries",
          queryIndex: 1,
          test: (result) => {
            return result.length === 1 &&
          ...
          expectedMessage: "Should return the sum of all salaries (787000)"
        },

        {
          id: 3,
          name: "Calculate average salary",
          queryIndex: 2,
          test: (result) => {
          ...
          expectedMessage: "Should return the average salary (~65583.33)"
        },

        {
          id: 4,
          name: "Find minimum and maximum salary",
          queryIndex: 3,
          test: (result) => {
            return result.length === 1 &&
          ...
          expectedMessage: "Should return the minimum (52000) and maximum (85000) salary"
        },

        {
          id: 5,
          name: "Count employees in a department",
          queryIndex: 4,
          test: (result) => {
            return result.length === 1 &&
                   result[0].it_count === 4;
          },
          hint: "Use WHERE department = 'IT' with COUNT(*)",
          expectedMessage: "Should return 4 (IT employees)"
        },

        {
          ...
          expectedMessage: "Should return 4 (unique departments)"
        }
      ]
    },
    pt: {
