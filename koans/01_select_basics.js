...
module.exports = (lang = 'en') => {
  const translations = {
    en: {
      title: "01 - SELECT Basics",
      description: "Learn to select data from a table",
      koans: [
        {
          id: 1,
          ...
          expectedMessage: "Should return 12 employees with all columns"
        },
        {
          id: 2,
          name: "Select only name and salary",
          queryIndex: 1,
          test: (result) => {
            return result.length === 12 &&
          ...
          expectedMessage: "Should return 12 employees with only 2 columns: name and salary"
        },
        {
          id: 3,
        ...
        {
          id: 4,
          name: "Use alias to rename column",
          queryIndex: 3,
          test: (result) => {
            return result.length === 12 &&
          ...
          expectedMessage: "Should return 12 employees with columns renamed to 'employee_name' and 'annual_salary'"
        },
        {
          id: 5,
          name: "Select a specific value from all",
          queryIndex: 4,
          test: (result) => {
            return result.length === 12 &&
          ...
          expectedMessage: "Should return only the 'department' column from all employees"
        }
      ]
    },
    pt: {
