...
module.exports = (lang = 'en') => {
  const translations = {
    en: {
      ...
      description: "Learn to create intermediate queries with WITH",
      koans: [
        {
          id: 1,
          name: "Basic CTE",
          ...
          expectedMessage: "Should return employees with salary > 70000 using CTE"
        },

        {
          ...
          expectedMessage: "Should use two CTEs to combine data"
        },

        {
          ...
          expectedMessage: "Should return salary statistics by department using CTE"
        },

        {
          ...
          expectedMessage: "Should create CTE that uses another CTE"
        },

        {
          id: 5,
          name: "CTE vs Subquery - readability",
          queryIndex: 4,
          test: (result) => {
          ...
          expectedMessage: "Should show employees with their department's average"
        },

        {
          id: 6,
          name: "CTE with complex JOIN",
          queryIndex: 5,
          test: (result) => {
            return result.every(r =>
          ...
          hint: "WITH employee_workload AS (JOIN and aggregations) SELECT ...",
          expectedMessage: "Should return each employee's workload (total hours and number of projects)"
        }
      ]
    },
    pt: {
